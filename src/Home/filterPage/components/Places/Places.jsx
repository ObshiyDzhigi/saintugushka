...
const Places = ({ selectedSubcategory, activeCategory, onSubcategorySelect }) => {
    ...
    // Восстановление выбранной категории из localStorage
    useEffect(() => {
    ...
    useEffect(() => {
        if (selectedSubcategoryId !== null) {
            localStorage.setItem('selectedCategory', selectedSubcategoryId);
        }
    ...
    // Восстановление выбранных подкатегорий из localStorage
    useEffect(() => {
